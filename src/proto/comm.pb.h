...
class Stream : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_header(::trpc::proto::SessionHeader* header);
...
class CallRequest : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_payload(::trpc::proto::CallPayload* payload);
...
class CallResponse : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_error(::trpc::proto::CallError* error);
...
inline void Stream::set_allocated_header(::trpc::proto::SessionHeader* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline void Error::set_type(::trpc::proto::Error_Type value) {
  assert(::trpc::proto::Error_Type_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void CallRequest::set_allocated_payload(::trpc::proto::CallPayload* payload) {
  delete payload_;
  payload_ = payload;
  if (payload) {
    set_has_payload();
...
inline void CallResponse::set_allocated_error(::trpc::proto::CallError* error) {
  delete error_;
  error_ = error;
  if (error) {
    set_has_error();
...
inline void CallResponse::set_allocated_payload(::trpc::proto::CallPayload* payload) {
  delete payload_;
  payload_ = payload;
  if (payload) {
    set_has_payload();
...
inline void CallError::set_type(::trpc::proto::CallError_Type value) {
  assert(::trpc::proto::CallError_Type_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void CallError::set_allocated_description(::std::string* description) {
  if (description_ != &::google::protobuf::internal::GetEmptyString()) {
    delete description_;
  }
  if (description) {
...
inline void CallPayload::set_allocated_data(::std::string* data) {
  if (data_ != &::google::protobuf::internal::GetEmptyString()) {
    delete data_;
  }
  if (data) {
